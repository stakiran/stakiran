...
大手企業で IT エンジニアに勤しむ傍ら、仕事術と知的生産術を探究。ニューロダイバージェントとしての経験を軸に、組織や社会の限界を広げるための概念づくりと検証を実施。その結果を記事、書籍、ソフトウェアやドキュメントとしてオープンに還元してきた。現在は一会社員、一個人としての立場の限界に直面し、組織的な検証や社会実装を目指して活動中。
